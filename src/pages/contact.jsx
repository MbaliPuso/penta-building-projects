                ...
                <div className="info">
                    <ul className="contact">
                        <li>
                            ...
                            <div>
                                <h3>Address:</h3>
                                <p>160 Taaifontein Street, Pretoria, South Africa</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <h3>Telephone:</h3>
                                <p>Tel:   +27 73 452 2526</p>
                                <p>Tel:   +27 72 995 2691</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <h3>Email:</h3>
                                <p>wouter@pentaprojects.co.za</p>
                                <p>johang@pentaprojects.co.za</p>
                            </div>
                        </li>
                    </ul>
                    <ul className="social-medias">
                        <li>
                            <a className="fb" href="https://www.facebook.com/pentabuildingprojects/" target="_blank">
                                <p>Facebook</p>
